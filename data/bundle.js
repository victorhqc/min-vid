...
const App = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'app' },
      this.props.error ? React.createElement(ErrorView, this.props) : !this.props.loaded ? React.createElement(LoadingView, this.props) : null,
      React.createElement(
        'div',
        { className: this.props.loaded ? 'player-wrap' : 'player-wrap hidden' },
        React.createElement(PlayerView, this.props)
      )
    );
  }
});
...
const ErrorView = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'error' },
      React.createElement('img', { src: 'img/sadface.png',
...
const LoadingView = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'loading', onMouseEnter: this.enterView, onMouseLeave: this.leaveView },
      React.createElement('a', { onClick: this.close, className: 'close ' + this.state.hovered ? '' : 'hidden' }),
      React.createElement('img', { src: 'img/loading-bars.svg',
...
const PlayerView = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { onMouseEnter: this.enterPlayer, onMouseLeave: this.leavePlayer, className: 'video-wrapper' },
      React.createElement(
        'div',
        { className: 'controls ' + (this.state.hovered ? '' : 'hidden ') + (this.props.minimized ? 'minimized' : ''),
          onMouseEnter: this.enterControls, onMouseLeave: this.leaveControls },
        React.createElement(
          'div',
          { className: 'left' },
          React.createElement('a', { onClick: this.play, className: this.props.playing ? 'play hidden' : 'play' }),
          React.createElement('a', { onClick: this.pause, className: this.props.playing ? 'pause' : 'pause hidden' }),
          React.createElement('a', { onClick: this.mute, className: !this.props.muted ? 'mute' : 'mute hidden' }),
          React.createElement('a', { onClick: this.unmute, className: this.props.muted ? 'unmute' : 'unmute hidden' }),
          React.createElement('input', { type: 'range', className: this.state.showVolume ? 'volume' : 'volume hidden',
            min: '0', max: '1', step: '.01', value: this.props.volume, onChange: this.setVolume })
        ),
        React.createElement(
          'div',
          { className: 'right' },
          React.createElement('a', { onClick: this.sendToTab, className: 'tab' }),
          React.createElement('a', { onClick: this.minimize, className: !this.props.minimized ? 'minimize' : 'minimize hidden' }),
          React.createElement('a', { onClick: this.maximize, className: this.props.minimized ? 'maximize' : 'maximize hidden' }),
          React.createElement('a', { onClick: this.close, className: 'close' })
        )
      ),
      React.createElement(
        'div',
        { className: 'progress ' + (this.state.hovered && !this.props.minimized ? '' : 'hidden') },
        React.createElement(
          'span',
          { className: 'domain' },
          this.props.domain
        ...
        React.createElement('progress', { className: 'video-progress', value: this.props.progress + '' })
      ),
      React.createElement('video', { id: 'video', ref: 'video', src: this.props.src, autoplay: false })
    );
  }
});

function renderApp() {
  ReactDOM.render(React.createElement(App, window.AppData), document.getElementById('container'));
}
renderApp();
